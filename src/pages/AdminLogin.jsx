...
const AdminLogin = ({ onClose, onAdminClick,onPhoneClick }) => {
  ...
  return (
    <>
              ...
              <div className='font-josefin fixed inset-0 md:w-[400px] w-[250px] h-[420px] lg:top-24 top-1/4 md:left-1/4 lg:left-[420px] left-16 bg-slate-200/40 text-white backdrop-blur-lg border text-center border-white/20 shadow-lg p-5 rounded-xl
'>
                  ...
                  <input type="text" placeholder="Password" className='bg-slate-100/30 backdrop-blur-md focus:placeholder-gray-400 border p-2 rounded mt-7 w-full text-sm text-[#000000] placeholder-gray-300 font-[500] font-sans' />
                      <button className='w-full mt-7 font-semibold p-2  rounded bg-[#F2C94C] text-[#0A2f5A] font-sans text-[16px]'>Login To Dashboard</button>
                  </div>
              </div>
